          ...
          >
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 font-medium mt-2">
                Where should we deliver your happiness?
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
              {colleges.map((college) => (
                <motion.button
                  ...
                  className={`relative p-4 rounded-3xl text-left transition-all border-4 w-full ${
                    selected === college.id
            ...
            <motion.button
              ...
              whileHover={
                selected ? { scale: 1.02, backgroundColor: "#dc2626" } : {}
              }
              whileTap={selected ? { scale: 0.98 } : {}}
              className={`w-full py-4 rounded-[2rem] font-black text-xl flex items-center justify-center gap-3 transition-all shadow-2xl ${
                selected
